...
class M0057_EpubTables : AddTableMigration() {

    private class EpubTaskTable : IntIdTable() {
    ...
    private class EpubChapterTable : IntIdTable() {
    ...
    private class EpubOutputTable : IntIdTable() {
        val taskId = integer("task_id")
