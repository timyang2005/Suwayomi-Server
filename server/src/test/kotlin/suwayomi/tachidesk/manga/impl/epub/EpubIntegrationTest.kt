    ...
    fun `epub with cover image produces valid file`() {
        ...
        val chapters = listOf(
            ChapterWithImages(
                chapterId = 1,
                title = "Chapter 1",
                images = listOf(ImageData("page1.jpg", createTestImage(100, 100)))
            )
        )
    ...
    fun `epub with Kindle page size`() {
        ...
        val chapters = listOf(
            ChapterWithImages(
                chapterId = 1,
                title = "Chapter 1",
                images = listOf(ImageData("page1.jpg", createTestImage(800, 1200)))
            )
        )
    ...
    fun `multiple images per chapter are all included`() {
        ...
        val chapters = listOf(
            ChapterWithImages(
                ...
                title = "Chapter 1",
                images = (1..10).map { i ->
                    ImageData("page$i.jpg", createTestImage(100, 100))
                }
            )
        )
